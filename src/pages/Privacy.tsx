        ...
        <div className="min-h-screen bg-background">
            ...
            <section className="min-h-screen flex flex-col justify-center items-left py-16 relative mx-auto w-5/6 md:w-3/4 lg:w-1/2">
                    ...
                    <div className="rounded-lg p-8 shadow-lg mb-3">
                        ...
                        <ul className="list-inside text-md md:text-lg list-decimal">
                    ...
                    <div className="rounded-lg p-8 shadow-lg mb-3">
                        ...
                        <ul className="list-disc list-inside mb-6 text-md md:text-lg">
                    ...
                    <div className="rounded-lg p-8 shadow-lg mb-3">
                        ...
                        Il trattamento dei dati attraverso le API Google avviene nel rispetto delle <a className="underline break-all" href="https://developers.google.com/terms/api-services-user-data-policy">Google API Services User
                    ...
                    <div className="rounded-lg p-8 shadow-lg mb-3">
                        ...
                        <ul className="list-disc list-inside text-md md:text-lg">
                            ...
                            <li className="mb-3">Proporre reclamo al Garante Privacy: <a className="underline break-all" href="https://www.garanteprivacy.it" target="_blank" rel="noopener noreferrer">www.garanteprivacy.it</a></li>
                        </ul>
                    </div>
                    <div className="rounded-lg p-8 shadow-lg mb-3">
                    ...
                    <div className="rounded-lg p-8 shadow-lg mb-3">
                        ...
                        <a className="underline break-all" href="https://www.glamro.it/cookie-policy" target="_blank" rel="noopener noreferrer">www.glamro.it/cookie-policy</a>
                        </p>
                    </div>
                    <div className="rounded-lg p-8 shadow-lg mb-5">
                        <h2 className="text-3xl font-semibold mb-2">11. Modifiche all'informativa</h2>
                        <p className="mb-6 text-md md:text-lg">
                        Eventuali modifiche saranno pubblicate su <a className="underline break-all" href="https://www.glamro.it" target="_blank" rel="noopener noreferrer">www.glamro.it</a> e/o notificate via App.
                        </p>
                    </div>
            </section>
            <Footer />
